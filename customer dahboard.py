...
bt1=Button(t,text='Save',width=15,command=showcustomerssave)
bt1.place(x=50,y=50)
...
bt6=Button(t,text='Navigate',width=15,command=showcustomer
           navigate)
